...
Input: Previous 24 months of inflation rates
Target: The following month's inflation rate
Model: Linear Regression
Train/Test split: 80% / 20%
Shuffle: Disabled to preserve the chronological order of the data
Results
